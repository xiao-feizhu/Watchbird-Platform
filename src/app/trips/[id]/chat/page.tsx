...
export default function ChatPage() {
  ...
  // Poll for new messages with request deduplication
  useEffect(() => {
    ...
    intervalRef.current = setInterval(async () => {
      ...
      try {
        await fetchMessages(`/api/chat/groups/${chatGroupId}/messages`)
      } finally {
            ...
            {isChatDisabled ? (
              ...
              <div className="flex gap-3">
                <textarea
                  ...
                  placeholder="输入消息..."
                  rows={2}
                  className="flex-1 rounded-lg border border-gray-300 px-4 py-2 focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200 outline-none resize-none disabled:bg-gray-100 disabled:cursor-not-allowed"
                  disabled={isSending}
                />
